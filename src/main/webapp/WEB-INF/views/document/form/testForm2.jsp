	    ...
	    <div id="insert_content" data-vo-check="${docuVO.documentId}" class="m-0 p-0" style="min-height: 400px; border: 1px solid #000; border-top: none;">
	      	 ...
	      	 <div class="col d-flex justify-content-center align-items-center">
				  ...
				  <thead>
				    <tr style="background-color: #d9edf7;">
				      <th colspan="7" style="padding: 10px; font-weight: bold;">상 세 내 용</th>
				    </tr>			
				  </thead>
				  <tbody id="tbody1">
					    <tr class="trs" style="height: 50px;">
					    	<td style="width: 20%;">내  용</td>
					    	<td class="tds" style="width: 80%;"></td>
					    </tr>
					    <tr class="trs" style="height: 50px;">
					    	<td style="width: 20%;">대  상</td>
					    	<td class="tds" style="width: 80%;"></td>					    	 
					    </tr>
					    <tr class="trs" style="height: 50px;">
					    	<td style="width: 20%;">절  차</td>
					    	<td class="tds" style="width: 80%;"></td>					    	 
					    </tr>
					    <tr class="trs" style="height: 50px;">
					    	<td style="width: 20%;">일  정</td>
					    	<td class="tds" style="width: 80%;"></td>					    	 
					    </tr>
					    <tr class="trs" style="height: 50px;">
					    	<td style="width: 20%;">예  산</td>
					    	<td class="tds" style="width: 80%;"></td>					    	 
					    </tr>
					    <tr class="trs" style="height: 50px;">
		    ...
		    <div class="col">
		      	<div class="m-0 p-0 text-center" style="border: 1px solid #000; border-top: none; height: 130px;">
		    		<div>위 내용과 같이 기안하오니 검토후 재가하여 주시기 바랍니다</div>
		    	</div>	
			</div>
