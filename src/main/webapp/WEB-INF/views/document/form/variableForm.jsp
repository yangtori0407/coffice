...
<body id="page-top">
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="card shadow mb-4" style="min-width: 1500px;">
			
				  <div class="card-body row m-0 p-0" >
				  	
				  	<div class="card left-content mr-3" style="width:100px; ">
					  ...
					  <div class="middle-content" style="width:1000px; box-sizing: border-box;">  
					    ...
					    <div class="row m-0 p-0" >	
					      ...
					      <div class="top-left col-4 p-0 m-0" >
					        <div class="card-header d-flex align-items-center justify-content-center" style=" padding: 8px; height: 50px;">문서 번호 (${docuVO.documentId})</div>
							...
							<div class="top-right col-8 d-flex flex-column p-0 m-0" style="border-left: 1px solid lightgray;">
							  ...
							  <!-- ✅ 제목 영역 -->
							  <div class="card-header approver-title d-flex align-items-center justify-content-center" style="height: 50px; ">
							    결재 라인
							  </div>
		    ...
		    <div class="row m-0 p-0 text-center mb-1" style="border: 1px solid lightgray;">
		      <div class="col-2 d-flex align-items-center justify-content-center" style="border-right: 1px solid lightgray; background-color: #f8f9fa;">기안자</div>
		      ...
		      <div class="col-2 d-flex align-items-center justify-content-center" style="border-right: 1px solid lightgray; background-color: #f8f9fa;">부서</div>
		    ...
		    <div class="row m-0 p-0 text-center mb-1" style="border: 1px solid lightgray; ">
		      <div class="col-2 d-flex align-items-center justify-content-center" style="border-right: 1px solid lightgray; background-color: #f8f9fa;" >작성일</div>
		      ...
		      <div class="col-2 d-flex align-items-center justify-content-center" style="border-right: 1px solid lightgray; background-color: #f8f9fa;">처리일</div>
		    ...
		    <div class="row m-0 p-0 text-center" style="border: 1px solid lightgray;">
		      <div class="col-2 d-flex align-items-center justify-content-center" style="border-right: 1px solid lightgray; background-color: #f8f9fa;">제목</div>
		    ...
		    <div class="row m-0 p-0 mt-3">
		      ...
		      <c:forEach items="${docuVO.approvalLineVOs}" var="i">
		      	<c:if test="${i.stepOrder eq docuVO.currentStep && i.userId eq sessionScope.user.userId}">
			        <button class="btn btn-outline-secondary mr-3" data-toggle="modal" data-target="#signMenu">                
		                결재하기
		            </button>
		            <button class="btn btn-outline-secondary mr-3" data-toggle="modal" data-target="#writeRejectReason">                
		                반려하기
		            </button>
		  ...
		  <div class="card right-content ml-3" style="width:250px;  background-color: #f8f9fa;">
		  		...
		  		<div class="right-2" style="height: 100px;">
		  			<c:choose>
						<c:when test="${(empty docuVO && isWritePage eq 1) || docuVO.status eq '임시저장' }">
							<div class="btn btn-primary d-flex align-items-center justify-content-center ml-3" style="height: 90%; width: 90%;" data-toggle="modal" data-target="#exampleModal" id="diagram">								
									사원 불러오기
							</div>
						</c:when>
						
						<c:otherwise>
							<div class="btn btn-secondary d-flex align-items-center justify-content-center ml-3" style="height: 90%; width: 90%;">								
									사원 불러오기
							</div>
						</c:otherwise>
					</c:choose>
