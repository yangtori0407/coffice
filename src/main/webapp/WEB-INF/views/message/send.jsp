	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
			...
			<body id="page-top">
											...
											<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
																...
																<c:forEach items="${list }" var="m">
																	<tr>
																		<td>
																			...
																			<c:choose>
																				<c:when
																					test="${m.receiveUsers[0].name eq null }">
																					${m.receiveUsers[0].userId }
																				</c:when>
																				<c:otherwise>
																					${m.receiveUsers[0].deptName }
																					${m.receiveUsers[0].name }
																				</c:otherwise>
																			</c:choose>
																		...
																		<td><a class="boardA"
																				href="./send/detail?messageNum=${m.messageNum }">${m.messageTitle}</a>
																		</td>
																		<td>${m.formatted}</td>
																		<td>
																			<div class="dropdown">
																				<button
																					class="btn btn-primary dropdown-toggle messageCheck"
																					type="button" data-toggle="dropdown"
																					aria-expanded="false" data-message-num=${m.messageNum }>
																					수신 확인
																				</button>
																				<div class="dropdown-menu" id="messageCheckArea${m.messageNum }">
												...
												<div class="row">
													...
													<div class="col-sm-12 col-md-7">
														<div class="dataTables_paginate paging_simple_numbers"
															...
															<ul class="pagination">
																...
																<c:forEach begin="${pager.start }" end="${pager.end }"
																	var="i">
																	<li
																		class="paginate_button page-item ${pager.nowPage == i ? 'active' : '' }">
																		<a href="./send?nowPage=${i }&search=${pager.search}&kind=${pager.kind}"
														...
														id=" dataTable_next"><a href="./send?nowPage=${pager.end+1 }&search=${pager.search}&kind=${pager.kind}"
				...
				<script src="/js/message/messageSend.js"></script>
				<!-- End Wrapper -->
