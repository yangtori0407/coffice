											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<tbody>
													<c:forEach items="${list }" var="m">
														<tr>
															<td><a class="boardA"
																href="./send/detail?messageNum=${m.messageNum }"
																style="color: #858796;"> <c:choose>
																	...
																	</c:choose> <c:if test="${m.receiveUsers.size() > 1 }">
															...
															<td>
																<div class="dropdown">
																	<button
																		...
																		aria-expanded="false"
																		data-message-num=${m.messageNum }>수신 확인</button>
																	<div class="dropdown-menu"
																		id="messageCheckArea${m.messageNum }"></div>
																</div>
															</td>
