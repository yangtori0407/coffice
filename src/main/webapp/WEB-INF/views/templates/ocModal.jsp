<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <script>
      ...
      function addSelectedEmployee(id, name, position, departmentName) {
        ...
        pill.setAttribute('data-selected-department', departmentName);
      ...
      //메신저 관련 js
      function message(selected, receiver) {
        for (s of selected) {
          receiver.prepend(createEmailReceiver(s));
        }
      }


      function createEmailReceiver(s) {
        const div = document.createElement("div")
