...
<body id="page-top">
				...
				<div class="container-fluid">
					...
					<div class="d-flex flex-column">
						<label>제목</label> <input type="text"
							...
							style="width: 100%;" value="${update.noticeTitle }"
							id="noticeTitle"> <label>내용</label>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body" id="attachesArea" data-notice-num="${update.noticeNum }">
								<c:forEach items="${update.files }" var="f">
									<div class="d-flex">
										<div class="p-1">${f.originName}</div>
										<button type="button" class="btn attachDelete"
											data-file-num="${f.fileNum }">X</button>
									</div>
								</c:forEach>
							</div>
						</div>
	...
	<script src="/js/posts/noticeUpdate.js"></script>
